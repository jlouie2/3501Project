...
//                //add in breaks after each case
    ...
    public String getReg0Data() {
        return "" + reg[0];
    }

    public String getReg1Data() {
        return "" + reg[1];
    }

    public String getReg2Data() {
        return "" + reg[2];
    }

    public String getReg3Data() {
        return "" + reg[3];
    }

    public String getReg4Data() {
        return "" + reg[4];
    }

    public String getReg5Data() {
        return "" + reg[5];
    }

    public String getReg6Data() {
        return "" + reg[6];
    }

    public String getReg7Data() {
        return "" + reg[7];
    }
